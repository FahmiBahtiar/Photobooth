          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-20">
            <div className="flex flex-col items-center">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-gray-800 mb-4">
                Boothkicot | Online Photo Strip Creator
              </h1>
              <p className="text-base md:text-lg text-center text-gray-600 mb-10 max-w-3xl mx-auto">
                Turn your home into a photobooth with exclusive templates, trendy filters, and fun stickers—beautiful results every time
              </p>
            ...
            <div className="flex flex-col md:flex-row gap-12 mb-16 items-center">
              ...
              <div className="md:w-1/2">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                  At-Home Photo Booth Experience
                </h2>
                <p className="text-gray-600 mb-8">
                  No more waiting in line or rushing through public booths—our online Photo Booth brings exclusive templates, trendy filters, and fun stickers right to your home. Snap unlimited strips at your own pace, and every shot looks amazing.
                </p>
                <Link 
                  href="/photo"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-5 rounded-3xl border border-cream-200">
                ...
                <p className="text-gray-700">
                  Choose a filter, then hit Start to capture four quick shots in a row—fast, fun, and completely.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-cream-50 p-8 rounded-2xl">
                ...
                <p className="text-gray-600">
                  "I love how this online Photo Booth lets me create perfect strips at home—totally! The exclusive templates are so stylish, the filters add amazing vibes, and the stickers are just adorable. It feels like my own personal studio!"
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="border-b border-cream-200 py-5">
                ...
                <p className="mt-3 text-gray-600">
                  Our at-home Photo Booth brings the classic multi-cut strip experience right to your screen. Simply snap four quick photos in seconds and watch them transform into a stylish photo strip with our exclusive templates.
                </p>
              </div>
              ...
              <div className="border-b border-cream-200 py-5">
                ...
                <p className="mt-3 text-gray-600">
                  100% —no hidden fees or subscriptions. Enjoy unlimited shots with our online Photo Booth, all from the comfort of home.
                </p>
              </div>
