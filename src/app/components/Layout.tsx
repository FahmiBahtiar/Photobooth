      ...
      <header className="w-full bg-white shadow-sm">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-4">
            ...
            />
          <h1 className="text-2xl font-bold text-amber-700">BEKICOT GROUPS</h1>
          </Link>
            ...
            <div className="mb-4 md:mb-0">
              <div className="flex items-center gap-2">
                <Image
                  ...
                  className="rounded-md"
                />
              <h3 className="text-xl font-bold mb-2">PhotoBooth</h3>
              </div>
              <p className="text-gray-200">Bekicot Photo Booth Service</p>
            </div>
            <div>
              <p className="text-gray-200">&copy; {new Date().getFullYear()} Bekicot Groups. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
